                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `purchased_from_suppliers_list`");
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-success"><?php echo $row["total_purchase_price"]; ?></td>
                                            <td class="text text-primary"><?php echo round($fetch_002["total_reciepts"],2); ?></td>
                                            <td class="text text-danger"><?php echo $row["total_purchase_price"] - round($fetch_002["total_reciepts"],2); ?></td>
