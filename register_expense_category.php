                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> ثبت کتگوری مصارف</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه ثبت کتگوری مصارف</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="expenses_category" class="col-form-label"> نام کتگوری</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark"  name="expenses_category" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="expenses_category" placeholder="بنویسید .. ">
                                </div>
