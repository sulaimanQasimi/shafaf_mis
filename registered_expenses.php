    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش مصارف </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش مصارف</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT expenses.*,expenses_categories.name as category_name,currencies.name as currency_name FROM `expenses` LEFT JOIN expenses_categories on expenses_categories.id = expenses.ex_cate_id LEFT JOIN currencies ON currencies.id = expenses.currenycy_id");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="register_expense.php?edit_id=<?php echo $row['id']; ?>">
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_expenses.php",'_self');            
