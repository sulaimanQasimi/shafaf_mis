    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            if(isset($_POST["btn_submit"]))
            {
                ...
                $sql_query_02 = mysqli_query($connection,"INSERT INTO `reciepts` (`id`, `full_name`, `amount`, `currency_id`,`rate`, `purchase_id`, `sale_id`, `date`, `details`) VALUES (NULL, '$full_name', '$amount', '$currency','$rate', '$purchase_id', NULL, '$date', '$details')");
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT reciepts.id,reciepts.full_name,reciepts.amount,reciepts.date,reciepts.rate,reciepts.details,(SELECT currencies.name FROM currencies WHERE currencies.id = reciepts.currency_id) as currency_name FROM reciepts WHERE reciepts.purchase_id = '$purchase_id'");
