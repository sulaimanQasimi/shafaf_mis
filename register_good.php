        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="page-title-box print-display">
                    ...
                    <p class="page-title">صفحه ثبت کالا</pack>
                </div> 
                <!-- end page title -->
                <?php 
                 ...
                 {
                     $id = $_GET["edit_id"];
                     $sql_query_001 = mysqli_query($connection,"SELECT * FROM `stock_minor` where id='$id'");
                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="good_name" class="col-form-label"> نام کالا</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark" value="<?php echo $fetch_001["item_name"]; ?>" data-toggle="input-mask" name="good_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="good_name" placeholder="بنویسید .. ">
                        ...
                        <div class="card-box">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="good_name" class="col-form-label"> نام کالا</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask" name="good_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="good_name" placeholder="بنویسید .. ">
