                                                    ...
                                                    <table class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                $count_2 = 1;
                                                                $sql_query_004 = mysqli_query($connection,"SELECT * FROM `view_list_of_sales` where sale_major_id='$parent_id'");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $fetch_004["purchase_price_t"]; ?></td>
                                                                <td><?php echo $fetch_004["sale_rate"]; ?></td>
                                                                <td><?php echo $fetch_004["sale_rate"] - $fetch_004["purchase_price_t"]; ?></td>
                                                                <td class="text text-success"><?php echo ($fetch_004["sale_rate"]) * $fetch_004["amount"]; ?></td>
