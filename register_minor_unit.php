    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="page-title-box print-display">
                <div class="page-title-right print-display">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> ثبت واحد فرعی</li>
                    </ol>
                </div>
                <p class="page-title">صفحه ثبت واحد فرعی</pack>
            </div>
            <!-- end page title -->
            ...
            <?php 
                 ...
                 {
                     $id = $_GET["edit_id"];
                     $sql_query_001 = mysqli_query($connection,"SELECT * FROM `unit_minor` where id='$id'");
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="employee_id" class="col-form-label">نام واحد اصلی</label>
                                    <span class="text-danger">*</span>
                                    <select class="form-control js-example-basic-single" id="add_minor_unit_major_id"
                                        name="add_minor_unit_major_id">
                                        <?php 
                                            $sql_query_001 = mysqli_query($connection,"select id,unit_name from unit_major");
                                            while ($row = mysqli_fetch_assoc($sql_query_001)) 
                                            {
                                            if($fetch_001["unit_major_id"] == $row["id"])
                                            {
                                            ?>
<option selected value="<?php echo $row["id"]; ?>"><?php echo $row["unit_name"]; ?>
                                        </option>
                                            <?php
                                            }
                                            else
                                            {
                                            ?>
<option value="<?php echo $row["id"]; ?>"><?php echo $row["unit_name"]; ?>
                                        </option>
                                            <?php
                                            }
                                            ?>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="unit_name" class="col-form-label">نام واحد فرعی</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark" value='<?php echo $fetch_001["unit_name"]; ?>' name="unit_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="unit_name"
                                        placeholder="بنویسید .. ">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="unit_pack_qantity" class="col-form-label">تعداد بسته</label>
                                    <span class="text-danger">*</span>
                                    <input type="number" value='<?php echo $fetch_001["pack_quantity"]; ?>' class="form-control  border border-dark"
                                        name="unit_pack_qantity"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="unit_pack_qantity"
                                        placeholder="بنویسید .. ">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="kg_factor" class="col-form-label">ضریب واحد اصلی</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" value='<?php echo $fetch_001["major_factor"]; ?>' class="form-control  border border-dark" name="kg_factor"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="kg_factor"
                                        placeholder="بنویسید .. ">
                                </div>
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="unit_name" class="col-form-label">نام واحد فرعی</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark" name="unit_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="unit_name"
                                        placeholder="بنویسید .. ">
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    <label for="kg_factor" class="col-form-label">ضریب واحد اصلی</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark" name="kg_factor"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="kg_factor"
                                        placeholder="بنویسید .. ">
                                </div>
