        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> ثبت واحد اصلی</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه ثبت واحد اصلی</pack>
                </div> 
                <!-- end page title -->
                ...
                <?php 
                 ...
                 {
                     $id = $_GET["edit_id"];
                     $sql_query_001 = mysqli_query($connection,"SELECT * FROM `unit_major` where id='$id'");
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="major_unit_name" class="col-form-label">نام واحد</label>
                                        <span class="text-danger">*</span>
                                        <input type="text" class="form-control  border border-dark" value="<?php echo $fetch_001["unit_name"]; ?>" name="major_unit_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="major_unit_name" placeholder="بنویسید .. ">
                            ...
                            <form   method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="major_unit_name" class="col-form-label">نام واحد</label>
                                        <span class="text-danger">*</span>
                                        <input type="text" class="form-control  border border-dark" name="major_unit_name" oninvalid="this.setCustomValidity('این بخش الزامی میباشد')" oninput="this.setCustomValidity('')" required id="major_unit_name" placeholder="بنویسید .. ">
