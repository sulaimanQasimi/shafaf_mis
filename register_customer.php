            ...
            <div class="page-title-box print-display">
                <div class="page-title-right print-display">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"> ثبت مشتری</li>
                    </ol>
                </div>
                <p class="page-title">صفحه ثبت مشتری</pack>
            </div>
            <!-- end page title -->
            <?php 
                 ...
                 {
                     $id = $_GET["edit_id"];
                     $sql_query_001 = mysqli_query($connection,"SELECT * FROM `customers` where id='$id'");
                        ...
                        <form method="post" action="server.php" id="uploadForm" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="customer_full_name" class="col-form-label">نام مکمل</label>
                                    <span class="text-danger">*</span>
                                    <input type="text" class="form-control  border border-dark"
                                        name="customer_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="customer_full_name" value="<?php echo $fetch_001["full_name"]; ?>"
                                        placeholder="بنویسید .. ">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control border border-dark" data-toggle="input-mask"
                                        ...
                                        data-mask-format="(00) 0000-0000" placeholder="بنویسید .. " value="<?php echo $fetch_001["phone_number"]; ?>" maxlength="10">
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control  border border-dark"
                                        name="customer_full_name"
                                        oninvalid="this.setCustomValidity('این بخش الزامی میباشد')"
                                        oninput="this.setCustomValidity('')" required id="customer_full_name"
                                        placeholder="بنویسید .. ">
