    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="page-title-box print-display">
                    ...
                    <p class="page-title">نمایش کارمندان</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"select * from staff");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="stuff_documents/images/<?php echo $row["image"]; ?>"><img class="img img-round" style="height:40px; width:40px; border:2px solid gray; border-radius:5px;" src="stuff_documents/images/<?php echo $row["image"]; ?>" alt=""></a>
                                            </td>
                                            <td><?php
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_employees.php",'_self');            
