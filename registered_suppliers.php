    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش تمویل کنندگان  </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش تمویل کنندگان  </pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `suppliers`");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="register_supplier.php?edit_id=<?php echo $row['id']; ?>">
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_suppliers.php",'_self');            
