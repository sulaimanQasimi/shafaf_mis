    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش کالا ها</li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش کالا ها</pack>
                </div> 
                <!-- end page title -->
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="register_good.php?edit_id=<?php echo $row['id']; ?>">
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_goods.php",'_self');            
