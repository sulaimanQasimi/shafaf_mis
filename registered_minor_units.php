    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش واحدات  فرعی </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش واحدات  فرعی </pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT unit_minor.*,unit_major.unit_name as major_unit_name FROM `unit_minor` LEFT JOIN unit_major ON unit_major.id = unit_minor.unit_major_id");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["major_unit_name"]; ?></td>
                                            <td><?php echo $row["pack_quantity"]; ?></td>
                                            <td><?php echo $row["major_factor"]; ?></td>
                                            
                                            <td>
                                                <i class="mdi mdi-delete-circle text text-danger" onclick="delete_func(<?php echo $row['id']; ?>)" title="حذف" style="cursor:pointer;"></i> | 
                                                <a href="register_minor_unit.php?edit_id=<?php echo $row['id']; ?>">
        ...
        <script>
            ...
            if(confirm == true)
            {
                ...
                window.open("registered_minor_units.php",'_self');            
