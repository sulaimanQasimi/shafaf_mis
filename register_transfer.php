    ...
    <body>
                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">صفحه ثبت انتقال از فابریکه به نمایندگی</li>
                        </ol>
                    </div>
                    <p class="page-title">صفحه ثبت انتقال از فابریکه به نمایندگی</pack>
                </div> 
                <!-- end page title -->
                                        ...
                                        <table class="table mt-4 table-sm table-centered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <p style="text-align:center; font-size:25px;" for="search_input_id">نمایندگی : </p>
            ...
            $(function(){
                ...
                $("#search_input_id").on("search",function(){
                    ...
                    success: function(response) {
                        ...
                        row += "<td><input type='text' class='form-control' readonly name='item_name' value='" + responses_x1["item_name"] + "' /><input type='hidden' class='form-control' readonly name='tr_fr_fac_supply_id' value='" + responses_x1["item_stock_minor_id"] + "' /></td>";
        ...
        <script>
            $("#button_submit").on("click",function(){
                ...
                var tr_fr_fac_supply_id = $('input[name^=tr_fr_fac_supply_id]').map(function(idx, elem) {
                    return $(elem).val();
                }).get();
                ...
                $.ajax({
                    type: "POST",
                    data: {
                        tr_fr_fac_supply_id: tr_fr_fac_supply_id,
