                ...
                <div class="page-title-box print-display">
                    <div class="page-title-right print-display">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"> نمایش کتگوری مصارفات </li>
                        </ol>
                    </div>
                    <p class="page-title">نمایش کتگوری مصارفات</pack>
                </div> 
                <!-- end page title -->
                        ...
                        <div class="card-box table-responsive">
                            <table id="datatable-buttons" class="table table-striped table-bordered  nowrap">
                                ...
                                <tbody>
                                    <?php
                                        $count = 1;
                                        $sql_query_001 = mysqli_query($connection,"SELECT * FROM `expenses_categories`");
